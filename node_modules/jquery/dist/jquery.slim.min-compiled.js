  ...
  var c = [],
    ...
    var a,
      ...
      var d,
          e,
          g = 0,
          h = [];if (t(a)) for (d = a.length; d > g; g++) e = b(a[g], g, c), null != e && h.push(e);else for (g in a) e = b(a[g], g, c), null != e && h.push(e);return f.apply([], h);
    ...
    var d = b[0];return c && (a = ":not(" + a + ")"), 1 === b.length && 1 === d.nodeType ? o.find.matchesSelector(d, a) ? [d] : [] : o.find.matches(a, o.grep(b, function (a) {
      ...
      }));for (b = 0; c > b; b++) o.find(a, e[b], d);return this.pushStack(c > 1 ? o.uniqueSort(d) : d);
    ...
    var e, f;if (!a) return this;if ((c = c || B, "string" == typeof a)) {
      if ((e = "<" === a[0] && ">" === a[a.length - 1] && a.length >= 3 ? [null, a, null] : C.exec(a), !e || !e[1] && b)) return !b || b.jquery ? (b || c).find(a) : this.constructor(b).find(a);if (e[1]) {
        if ((b = b instanceof o ? b[0] : b, o.merge(this, o.parseHTML(e[1], b && b.nodeType ? b.ownerDocument || b : d, !0)), y.test(e[1]) && o.isPlainObject(b))) for (e in b) o.isFunction(this[e]) ? this[e](b[e]) : this.attr(e, b[e]);return this;
      ...
      var c,
          ...
          e = this.length,
          f = [],
          g = "string" != typeof a && o(a);if (!x.test(a)) for (; e > d; d++) for (c = this[d]; c && c !== b; c = c.parentNode) if (c.nodeType < 11 && (g ? g.index(c) > -1 : 1 === c.nodeType && o.find.matchesSelector(c, a))) {
        f.push(c);break;
    ...
    a = "string" == typeof a ? I(a) : o.extend({}, a);var b,
      ...
      for (e = a.once, d = b = !0; g.length; h = -1) {
        ...
        return o.each(arguments, function (a, b) {
          var c;while ((c = o.inArray(b, f, c)) > -1) f.splice(c, 1), h >= c && h--;
        }), this;
      }, has: function has(a) {
    ...
    throw a;
          ...
          var g = 0;function h(b, c, d, f) {
            return function () {
              var i = this === e ? void 0 : this,
                  ...
                  k = function k() {
                var a, e;if (!(g > b)) {
                  if ((a = d.apply(i, j), a === c.promise())) throw new TypeError("Thenable self-resolution");e = a && ("object" == typeof a || "function" == typeof a) && a.then, o.isFunction(e) ? f ? e.call(a, h(g, c, J, f), h(g, c, K, f)) : (g++, e.call(a, h(g, c, J, f), h(g, c, K, f), h(g, c, J, c.notify))) : (d !== J && (i = void 0, j = [a]), (f || c.resolveWith)(i || c.promise(), j));
                }
              },
                  l = f ? k : function () {
                try {
      ...
      };if (f > 0) for (b = new Array(f); f > c; c++) d[c] && o.isFunction(a = d[c].promise) ? a.call(d[c]).done(i(c)).fail(h.reject) : d[c] && o.isFunction(a = d[c].then) ? a.call(d[c], i(c), h.reject) : i(c)(d[c]);else h.resolveWith();return h.promise();
    ...
    var h = 0,
      ...
      e = !0;for (h in c) O(a, b, h, c[h], !0, f, g);
    ...
    this.expando = o.expando + Q.uid++;
      ...
      var d,
          e = this.cache(a);if ("string" == typeof b) e[o.camelCase(b)] = c;else for (d in b) e[o.camelCase(d)] = b[d];return e;
      ...
      var c,
        ...
        if (void 0 !== b) {
          o.isArray(b) ? b = b.map(o.camelCase) : (b = o.camelCase(b), b = b in d ? [b] : b.match(H) || []), c = b.length;while (c--) delete d[b[c]];
    ...
    var d;if (void 0 === c && 1 === a.nodeType) if ((d = "data-" + b.replace(U, "-$&").toLowerCase(), c = a.getAttribute(d), "string" == typeof c)) {
      ...
      var c,
        ...
        if (this.length && (e = S.get(f), 1 === f.nodeType && !R.get(f, "hasDataAttrs"))) {
          c = g.length;while (c--) g[c] && (d = g[c].name, 0 === d.indexOf("data-") && (d = o.camelCase(d.slice(5)), V(f, d, e[d])));R.set(f, "hasDataAttrs", !0);
        }return e;
      ...
      var c,
          ...
          h = function h() {
        --d || e.resolveWith(f, [f]);
      };"string" != typeof a && (b = a, a = void 0), a = a || "fx";while (g--) c = R.get(f[g], a + "queueHooks"), c && c.empty && (d++, c.empty.add(h));return h(), e.promise(b);
    ...
    var e,
      ...
      j = j || k[3], c = c || [], k = +i || 1;do f = f || ".5", k /= f, o.style(a, b, k + j); while (f !== (f = h() / i) && 1 !== f && --g);
    ...
    for (var c, d, e = [], f = 0, g = a.length; g > f; f++) d = a[f], d.style && (c = d.style.display, b ? ("none" === c && (e[f] = R.get(d, "display") || null, e[f] || (d.style.display = "")), "" === d.style.display && "none" === o.css(d, "display") && o.contains(d.ownerDocument, d) && (e[f] = ba(d))) : "none" !== c && (e[f] = "none", R.set(d, "display", c)));for (f = 0; g > f; f++) null != e[f] && (a[f].style.display = e[f]);return a;
    ...
    for (var f, g, h, i, j, k, l = b.createDocumentFragment(), m = [], n = 0, p = a.length; p > n; n++) if ((f = a[n], f || 0 === f)) if ("object" === o.type(f)) o.merge(m, f.nodeType ? [f] : f);else if (ja.test(f)) {
      g = g || l.appendChild(b.createElement("div")), h = (ea.exec(f) || ["", ""])[1].toLowerCase(), i = ga[h] || ga._default, g.innerHTML = i[1] + o.htmlPrefilter(f) + i[2], k = i[0];while (k--) g = g.lastChild;o.merge(m, g.childNodes), g = l.firstChild, g.textContent = "";
    } else m.push(b.createTextNode(f));l.textContent = "", n = 0;while (f = m[n++]) if (d && o.inArray(f, d) > -1) e && e.push(f);else if ((j = o.contains(f.ownerDocument, f), g = ha(l.appendChild(f), "script"), j && ia(g), c)) {
      k = 0;while (f = g[k++]) fa.test(f.type || "") && c.push(f);
    }return l;
  }!(function () {
    ...
    var g, h;if ("object" == typeof b) {
      "string" != typeof c && (d = d || c, c = void 0);for (h in b) ra(a, h, c, d, b[h], f);return a;
      ...
      var f,
        ...
        }), b = (b || "").match(H) || [""], j = b.length;while (j--) h = na.exec(b[j]) || [], n = q = h[1], p = (h[2] || "").split(".").sort(), n && (l = o.event.special[n] || {}, n = (e ? l.delegateType : l.bindType) || n, l = o.event.special[n] || {}, k = o.extend({ type: n, origType: q, data: d, handler: c, guid: c.guid, selector: e, needsContext: e && o.expr.match.needsContext.test(e), namespace: p.join(".") }, f), (m = i[n]) || (m = i[n] = [], m.delegateCount = 0, l.setup && l.setup.call(a, d, p, g) !== !1 || a.addEventListener && a.addEventListener(n, g)), l.add && (l.add.call(a, k), k.handler.guid || (k.handler.guid = c.guid)), e ? m.splice(m.delegateCount++, 0, k) : m.push(k), o.event.global[n] = !0);
      }
      ...
      var f,
        ...
        b = (b || "").match(H) || [""], j = b.length;while (j--) if ((h = na.exec(b[j]) || [], n = q = h[1], p = (h[2] || "").split(".").sort(), n)) {
        ...
        } else for (n in i) o.event.remove(a, n + b[j], c, d, !0);o.isEmptyObject(i) && R.remove(a, "handle events");
      }
      ...
      a = o.event.fix(a);var b,
        ...
        h = o.event.handlers.call(this, a, j), b = 0;while ((f = h[b++]) && !a.isPropagationStopped()) {
          a.currentTarget = f.elem, c = 0;while ((g = f.handlers[c++]) && !a.isImmediatePropagationStopped()) (!a.rnamespace || a.rnamespace.test(g.namespace)) && (a.handleObj = g, a.data = g.data, d = ((o.event.special[g.origType] || {}).handle || g.handler).apply(f.elem, i), void 0 !== d && (a.result = d) === !1 && (a.preventDefault(), a.stopPropagation()));
      ...
      var c,
        ...
        for (d = [], c = 0; h > c; c++) f = b[c], e = f.selector + " ", void 0 === d[e] && (d[e] = f.needsContext ? o(e, this).index(i) > -1 : o.find(e, this, null, [i]).length), d[e] && d.push(f);d.length && g.push({ elem: i, handlers: d });
      ...
      if (a[o.expando]) return a;var b,
          ...
          e = a.type,
          f = a,
          g = this.fixHooks[e];g || (this.fixHooks[e] = g = ma.test(e) ? this.mouseHooks : la.test(e) ? this.keyHooks : {}), d = g.props ? this.props.concat(g.props) : this.props, a = new o.Event(f), b = d.length;while (b--) c = d[b], a[c] = f[c];return 3 === a.target.nodeType && (a.target = a.target.parentNode), g.filter ? g.filter(a, f) : a;
    ...
    b = f.apply([], b);var e,
      ...
      for (h = o.map(ha(e, "script"), ya), i = h.length; p > n; n++) j = e, n !== q && (j = o.clone(j, !0, !0), i && o.merge(h, ha(j, "script"))), c.call(a[n], j, n);if (i) for (k = h[h.length - 1].ownerDocument, o.map(h, za), n = 0; i > n; n++) j = h[n], fa.test(j.type || "") && !R.access(j, "globalEval") && o.contains(k, j) && (j.src ? o._evalUrl && o._evalUrl(j.src) : m(j.textContent.replace(wa, ""), k));
    }return a;
  }function Da(a, b, c) {
    for (var d, e = b ? o.filter(b, a) : a, f = 0; null != (d = e[f]); f++) c || 1 !== d.nodeType || o.cleanData(ha(d)), d.parentNode && (c && o.contains(d.ownerDocument, d) && ia(ha(d, "script")), d.parentNode.removeChild(d));return a;
      ...
      var d,
          ...
          g,
          h = a.cloneNode(!0),
          i = o.contains(a.ownerDocument, a);if (!(l.noCloneChecked || 1 !== a.nodeType && 11 !== a.nodeType || o.isXMLDoc(a))) for (g = ha(h), f = ha(a), d = 0, e = f.length; e > d; d++) Ba(f[d], g[d]);if (b) if (c) for (f = f || ha(a), g = g || ha(h), d = 0, e = f.length; e > d; d++) Aa(f[d], g[d]);else Aa(a, h);return g = ha(h, "script"), g.length > 0 && ia(g, !i && ha(a, "script")), h;
    }, cleanData: function cleanData(a) {
      for (var b, c, d, e = o.event.special, f = 0; void 0 !== (c = a[f]); f++) if (P(c)) {
        if (b = c[R.expando]) {
          if (b.events) for (d in b.events) e[d] ? o.event.remove(c, d) : o.removeEvent(c, d, b.handle);c[R.expando] = void 0;
      ...
      for (var a, b = 0; null != (a = this[b]); b++) 1 === a.nodeType && (o.cleanData(ha(a, !1)), a.textContent = "");return this;
      ...
      return O(this, function (a) {
        var b = this[0] || {},
          ...
          a = o.htmlPrefilter(a);try {
            for (; d > c; c++) b = this[c] || {}, 1 === b.nodeType && (o.cleanData(ha(b, !1)), b.innerHTML = a);b = 0;
          } catch (e) {}
    ...
    o.fn[a] = function (a) {
      for (var c, d = [], e = o(a), f = e.length - 1, h = 0; f >= h; h++) c = h === f ? this : this.clone(!0), o(e[h])[b](c), g.apply(d, c.get());return this.pushStack(d);
    };
  });var Ea = /^margin/,
    ...
    if (a in Oa) return a;var b = a[0].toUpperCase() + a.slice(1),
        c = Na.length;while (c--) if ((a = Na[c] + b, a in Oa)) return a;
  }function Qa(a, b, c) {
    var d = X.exec(b);return d ? Math.max(0, d[2] - (c || 0)) + (d[3] || "px") : b;
  }function Ra(a, b, c, d, e) {
    for (var f = c === (d ? "border" : "content") ? 4 : "width" === b ? 1 : 0, g = 0; 4 > f; f += 2) "margin" === c && (g += o.css(a, c + Y[f], !0, e)), d ? ("content" === c && (g -= o.css(a, "padding" + Y[f], !0, e)), "margin" !== c && (g -= o.css(a, "border" + Y[f] + "Width", !0, e))) : (g += o.css(a, "padding" + Y[f], !0, e), "padding" !== c && (g += o.css(a, "border" + Y[f] + "Width", !0, e)));return g;
  }function Sa(b, c, e) {
    var f,
        g = !0,
        h = Ga(b),
    ...
    o.cssHooks[a + b] = { expand: function expand(c) {
        for (var d = 0, e = {}, f = "string" == typeof c ? c.split(" ") : [c]; 4 > d; d++) e[a + Y[d] + b] = f[d] || f[d - 2] || f[0];return e;
      ...
      return O(this, function (a, b, c) {
        var d,
            ...
            f = {},
            g = 0;if (o.isArray(b)) {
          for (d = Ga(a), e = b.length; e > g; g++) f[b[g]] = o.css(a, b[g], !1, d);return f;
    ...
    return a.toLowerCase();
      ...
      var c,
          d = 0,
          e = b && b.match(H);if (e && 1 === a.nodeType) while (c = e[d++]) a.removeAttribute(c);
    ...
    return a.getAttribute && a.getAttribute("class") || "";
      ...
      var b,
        ...
        b = a.match(H) || [];while (c = this[i++]) if ((e = $a(c), d = 1 === c.nodeType && (" " + e + " ").replace(Za, " "))) {
          g = 0;while (f = b[g++]) d.indexOf(" " + f + " ") < 0 && (d += f + " ");h = o.trim(d), e !== h && c.setAttribute("class", h);
        }
      }return this;
      ...
      var b,
        ...
        b = a.match(H) || [];while (c = this[i++]) if ((e = $a(c), d = 1 === c.nodeType && (" " + e + " ").replace(Za, " "))) {
          g = 0;while (f = b[g++]) while (d.indexOf(" " + f + " ") > -1) d = d.replace(" " + f + " ", " ");h = o.trim(d), e !== h && c.setAttribute("class", h);
        }
      }return this;
      ...
      var c = typeof a;return "boolean" == typeof b && "string" === c ? b ? this.addClass(a) : this.removeClass(a) : o.isFunction(a) ? this.each(function (c) {
        ...
        var b, d, e, f;if ("string" === c) {
          d = 0, e = o(this), f = a.match(H) || [];while (b = f[d++]) e.hasClass(b) ? e.removeClass(b) : e.addClass(b);
      ...
      var b,
          c,
          d = 0;b = " " + a + " ";while (c = this[d++]) if (1 === c.nodeType && (" " + $a(c) + " ").replace(Za, " ").indexOf(b) > -1) return !0;return !1;
      ...
      var b,
        ...
        if (arguments.length) return d = o.isFunction(a), this.each(function (c) {
          ...
          var c,
              ...
              e = a.options,
              f = o.makeArray(b),
              g = e.length;while (g--) d = e[g], (d.selected = o.inArray(o.valHooks.option.get(d), f) > -1) && (c = !0);return c || (a.selectedIndex = -1), f;
    ...
    o.valHooks[this] = { set: function set(a, b) {
      ...
      var g,
          ...
          r = k.call(b, "namespace") ? b.namespace.split(".") : [];if ((h = i = e = e || d, 3 !== e.nodeType && 8 !== e.nodeType && !ab.test(q + o.event.triggered) && (q.indexOf(".") > -1 && (r = q.split("."), q = r.shift(), r.sort()), l = q.indexOf(":") < 0 && "on" + q, b = b[o.expando] ? b : new o.Event(q, "object" == typeof b && b), b.isTrigger = f ? 2 : 3, b.namespace = r.join("."), b.rnamespace = b.namespace ? new RegExp("(^|\\.)" + r.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, b.result = void 0, b.target || (b.target = e), c = null == c ? [b] : o.makeArray(c, [b]), n = o.event.special[q] || {}, f || !n.trigger || n.trigger.apply(e, c) !== !1))) {
        if (!f && !n.noBubble && !o.isWindow(e)) {
          for (j = n.delegateType || q, ab.test(j + q) || (h = h.parentNode); h; h = h.parentNode) p.push(h), i = h;i === (e.ownerDocument || d) && p.push(i.defaultView || i.parentWindow || a);
        }g = 0;while ((h = p[g++]) && !b.isPropagationStopped()) b.type = g > 1 ? j : n.bindType || q, m = (R.get(h, "events") || {})[b.type] && R.get(h, "handle"), m && m.apply(h, c), m = l && h[l], m && m.apply && P(h) && (b.result = m.apply(h, c), b.result === !1 && b.preventDefault());return b.type = q, f || b.isDefaultPrevented() || n._default && n._default.apply(p.pop(), c) !== !1 || !P(e) || l && o.isFunction(e[q]) && !o.isWindow(e) && (i = e[l], i && (e[l] = null), o.event.triggered = q, e[q](), o.event.triggered = void 0, i && (e[l] = i)), b.result;
      }
    ...
    });else for (c in a) fb(c, a[c], b, e);return d.join("&");
    ...
    return o.isWindow(a) ? a : 9 === a.nodeType && a.defaultView;
      ...
      return this.map(function () {
        var a = this.offsetParent;while (a && "static" === o.css(a, "position")) a = a.offsetParent;return a || Ha;
      });
